...
@Entity
@Table(name = "electricity_forcasts")
public class ElectricityForecast {
    ...
    public ElectricityForecast(LocalDateTime start, LocalDateTime estimatedStop, Address address, boolean peopleReport) {
        this.id = 0;
        this.start = start;
    ...
    public boolean equals(Object obj) {
        ...
        ElectricityForecast that = (ElectricityForecast) obj;
