...
@RestController
@RequestMapping("/electricityforecast")
public class ElectricityForecastController {
    ...
    public ElectricityForecast getElectricityForecast(@PathVariable("id") long id) throws ForecastNotFoundException {
    ...
    public List<ElectricityForecast> getForecastsByTime(@RequestParam(name = "start") String startTime) {
    ...
    public void addNewElectricityForecast(@RequestBody ElectricityForecast forecast) throws ForecastAlreadyExistsException {
